...
/**
 `ShoeBrandLayout` is a subclass of `UICollectionViewLayout`
 ...
 */
open class ShoeBrandLayout: UICollectionViewLayout {
...
private extension ShoeBrandLayout {
